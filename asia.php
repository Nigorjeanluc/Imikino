		...
		<div class="">
			<div class="row">
				<div id="main-content" class="col-md-8">
					<?php
						$sql = mysqli_query($dbcon,"SELECT * FROM news WHERE Place = 'Asia' ORDER BY ID DESC LIMIT 0,10");
					...
					<div class="box">
						...
						<div class="wrap-vid">
							...
							<p>';
							echo truncate(htmlspecialchars_decode($row['Content']));
