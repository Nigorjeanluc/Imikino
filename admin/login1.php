...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Log in| imikino.net </title>
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="../../index2.html">Journalist|<span style="font-family:cursive;font-size:40px;font-style:italic;text-shadow: 3px 4px 4px black;" class="logo">
      ...
      ?>
        <form action="../opera/loginjour.php" method="post">
