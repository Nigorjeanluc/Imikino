        ...
        <section class="content">
          ...
          <div class="box-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <?php
                include("../connect.php");
                $sqli="SELECT * FROM news WHERE Author='$name' ORDER BY ID DESC";
                    ...
                    <div class="modal fade" id="myModal'.$row['ID'].'" tabindex="-1" role="dialog" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-sm">
                        ...
                        <div style="padding:5px" class="row text-center">
                          ...
                          <div class="col-md-12"><p>Do you really want to delete this?</p><p><a href="../opera/delproduct.php?delll='.$row['ID'].'" class="btn btn-success">Delete</a> | <button type="button" class="btn bg-orange" data-dismiss="modal">Cancel</button></p></div>
                        </div>
                        </div>
                      </div>
                    </div>';
