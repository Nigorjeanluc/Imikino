...
<head>
    ...
    <title>Basketball | imikino.net</title>
		...
		<div class="">
			<div class="row">
				<div id="main-content" class="col-md-8">
					<?php
						$sql = mysqli_query($dbcon,"SELECT * FROM news WHERE Categorie = 'Basketball' ORDER BY ID DESC LIMIT 0,10");
					...
					<div class="box">
						...
						<div class="wrap-vid">
							...
							<p>'.truncate(html_entity_decode($row['Content'])).' <a href="single.php?art='.$row['ID'].'">MORE...</a></p>
						</div>
					</div>
					<hr class="line">';
						}
